...
# Summary:
# This script continually monitors the instances for inactivity due to low/no processor usage and an SSH session having no activity and automatically shuts down the instance if these conditions are continuously met for a specified number of minutes.
